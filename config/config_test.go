...
func (suite *ConfigTestSuite) TestValidateConfDefault() {
	...
	assert.Equal(suite.T(), "voipkey.pem", suite.ConfGorushDefault.Ios.VoipKeyPath)
	assert.Equal(suite.T(), "", suite.ConfGorushDefault.Ios.VoipKeyBase64)
...
func (suite *ConfigTestSuite) TestValidateConf() {
	...
	assert.Equal(suite.T(), "voipkey.pem", suite.ConfGorush.Ios.VoipKeyPath)
	assert.Equal(suite.T(), "", suite.ConfGorush.Ios.VoipKeyBase64)
